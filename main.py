...
from engines.googletranslate import GoogleTranslateEngine
from engines.libretranslate import LibreTranslateEngine
from engines.utils import *

config = ConfigParser()

config.read(['/etc/simpletranslate/shared.conf', '/etc/simpletranslate/web.conf'])
